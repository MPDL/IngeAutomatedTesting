 ...
 *
 */
public class FullSimpleNoSourceTest extends BaseLoggedInUserTest {
	...
	@Test(priority = 5, dependsOnMethods = { "fullSubmissionSimpleNoSource" })
	...
	@Test(priority = 7, dependsOnMethods = { "fullSubmissionSimpleNoSource" })
